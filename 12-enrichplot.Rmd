...
```{r Barplot, fig.height=5, fig.width=8, fig.cap="(ref:Barplotcap)", fig.scap="(ref:Barplotscap)", fig.align="center"}
library(enrichplot)
...
```{r Dotplotcap, fig.width=12, fig.height=8, fig.cap="(ref:Dotplotcap)", fig.scap="(ref:Dotplotscap)", fig.align="center"}
...
```{r Networkplot, fig.width=12, fig.height=18, fig.cap="(ref:Networkplotcap)", fig.scap="(ref:Networkplotscap)", fig.align="center"}
...
```{r cnetNodeLabel, fig.height=12, fig.width=16, fig.cap="(ref:cnetNodeLabelcap)", fig.scap="(ref:cnetNodeLabelscap)", fig.align="center"}
...
```{r Heatplot, fig.width=16, fig.height=8, fig.cap="(ref:Heatplotcap)", fig.scap="(ref:Heatplotscap)", fig.align="center"}
p1 <- heatplot(edox)
...
The `emapplot` function supports results obtained from hypergeometric test and gene set enrichment analysis.The `pie_scale` parameter can be used to resize nodes and
the `layout` parameter can adjust the layout.
...
```{r Enrichment, fig.height=12, fig.width=16, fig.cap="(ref:Enrichmentcap)", fig.scap="(ref:Enrichmentscap)", fig.align="center"}
p1 <- emapplot(edo)
...
The `emapplot` function also supports results obtained from `compareCluster` function of `clusterProfiler` package. In addition to `pie_scale` and `layout` parameters, the number of circles in the bottom left corner can be adjusted  using the `legend_n` parameter. And proportion of clusters in the pie chart can be adjusted using the `pie` parameter, when `pie="count"`, the proportion of  clusters in the pie chart is determined by the number of genes.
...
```{r Enrichment2, fig.height=12, fig.width=16, fig.cap="(ref:Enrichment2cap)", fig.scap="(ref:Enrichment2scap)", fig.align="center"}
...
```{r upsetORA, fig.width=12, fig.height=5, fig.cap="(ref:upsetORAcap)", fig.scap="(ref:upsetORAscap)", fig.align="center"}
upsetplot(edo)
```
...
```{r upsetGSEA, fig.height=5, fig.width=12, fig.cap="(ref:upsetGSEAcap)", fig.scap="(ref:upsetGSEAscap)", fig.align="center"}
upsetplot(kk2) 
```
...
```{r ridgeplot, fig.width=12, fig.height=8, message=FALSE, fig.cap="(ref:ridgeplotcap)", fig.scap="(ref:ridgeplotscap)", fig.align="center"}
ridgeplot(edo2)
```
...
```{r gseaplot, fig.width=12, fig.height=16, fig.cap="(ref:gseaplotcap)", fig.scap="(ref:gseaplotscap)", fig.align="center"}
...
```{r gseaplot2, fig.width=12, fig.height=8, fig.cap="(ref:gseaplot2cap)", fig.scap="(ref:gseaplot2scap)", fig.align="center"}
...
```{r gseaplot22, fig.width=12, fig.height=8, fig.cap="(ref:gseaplot22cap)", fig.scap="(ref:gseaplot22scap)", fig.align="center"}
...
```{r gseaplot23, fig.width=12, fig.height=8, fig.cap="(ref:gseaplot23cap)", fig.scap="(ref:gseaplot23scap)", fig.align="center"}
...
```{r gseaplot24, fig.width=12, fig.height=8, fig.cap="(ref:gseaplot24cap)", fig.scap="(ref:gseaplot24scap)", fig.align="center"}
...
```{r gsearank, fig.width=8, fig.height=4, fig.cap="(ref:gsearankcap)", fig.scap="(ref:gsearankscap)", fig.align="center"}
...
```{r gsearank2, fig.width=8, fig.height=12, fig.cap="(ref:gsearank2cap)", fig.scap="(ref:gsearank2scap)", fig.align="center"}
library(ggplot2)
library(cowplot)
...
```{r pmcplot, fig.width=14, fig.height=6, fig.cap="(ref:pmcplotcap)", fig.scap="(ref:pmcplotscap)", fig.align="center"}
...
```{r goplot, fig.height=12, fig.width=8, eval=FALSE, fig.cap="(ref:goplotcap)", fig.scap="(ref:goplotscap)", fig.align="center"}
goplot(ego)
```
